<template>
  <div class="min-h-screen bg-gradient-to-br from-purple-50 to-indigo-50 dark:from-neutral-900 dark:to-neutral-800">
    ...
    <section class="py-16 px-4 md:px-8" ref="trendingSection">
      <div class="max-w-6xl mx-auto">
        <Transition appear enter-active-class="transition duration-1000 ease-out" enter-from-class="opacity-0"
          enter-to-class="opacity-100">
          <div v-if="visibleSections.features" class="text-center mb-12">
            <h2 class="text-3xl md:text-4xl font-bold text-gray-800 dark:text-white mb-4">
              What You'll Find Here
            </h2>
            <p class="text-lg text-gray-600 dark:text-gray-300">
              Everything you need to satisfy your GIF cravings
            </p>
          </div>
        </Transition>

        <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
          <Transition v-for="(gif, index) in trendingGifs" :key="gif.id" appear
            ...
            <div v-if="visibleSections.trending"
              ...
              <div
                ...
                <div class="relative">
                  <img :src="gif.url" :alt="`Trending GIF ${gif.id}`" class="w-full h-48 object-cover" />
...
const trendingGifs = [
  { id: 1, url: '/placeholder.svg?height=200&width=300', category: 'Funny' },
  { id: 2, url: '/placeholder.svg?height=200&width=300', category: 'Reactions' },
  { id: 3, url: '/placeholder.svg?height=200&width=300', category: 'Animals' },
  { id: 4, url: '/placeholder.svg?height=200&width=300', category: 'Sports' },
  { id: 5, url: '/placeholder.svg?height=200&width=300', category: 'Movies' },
  { id: 6, url: '/placeholder.svg?height=200&width=300', category: 'Memes' },
];
onMounted(() => {
